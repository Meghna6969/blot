...
const randsize1 = -0.3 * -36 
const base1 = -153
const radius1 = base / randsize
var xoff1 = 126
var yoff1 =  44.3
const divise1 = 0.5 + 1.0

//logCircle
const log8 = [
  bt.nurbs([
    [-6+xoff1 + radius1, 0 + yoff1],
    [-5+xoff1 + radius1 / divise1, radius1 / divise1 + yoff1],
    [1+xoff1, -2 + radius1 + yoff1],
    [3+xoff1 - radius1 / divise1, radius1 / divise1 + yoff1],
    [8+xoff1 + -radius1, 0 + yoff1],
    [5+xoff1 - radius1 / divise1, -radius1 / divise1 + yoff1],
    [-2+xoff1, 3 - radius1 + yoff1],
...
bt.translate( leafL4, [77.3, 60]);
bt.rotate( leafL4, 244);
...
bt.translate( leafL5, [77.3, 65]);
bt.rotate( leafL5, 229);
...
bt.translate( leafL6, [68.7, 90]);
bt.rotate( leafL6, 242);
...
bt.rotate( line2, 70);
//const threeLeaf = bt.join(anotherL,anotherL2,line1,line2);
//drawLines(threeLeaf);
...
bt.translate( leaf1LE, [49.4, 61]);
bt.rotate( leaf1LE, 63);
drawLines(leaf1LE);
...
bt.translate( leaf5LE, [58.5, 97]);
bt.rotate( leaf5LE, -128);
drawLines(leaf5LE);
